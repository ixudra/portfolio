        ...
        <table class="table table-striped">
            ...
            @foreach( $customers as $customer )
                <tr>
                    ...
                    <td>{!! HTML::linkRoute('admin.customers.show', $customer->object->email, array($customer->id)) !!}</td>
                    <td class="table-small">
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li>{!! HTML::iconRoute('admin.customers.show', Translate::recursive('common.delete'), 'trash-alt', array($customer->id, '_token' => csrf_token()), array('class' => 'btn btn-actions pull-left rest', 'data-method' => 'DELETE')) !!}</li>
                            </ul>
                        </div>
                    </td>
                </tr>
