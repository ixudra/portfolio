<div class="row">
    {!! Form::open(array('url' => '/admin/projectTypes/filter', 'method' => 'POST', 'id' => 'filterCustomers', 'class' => 'form-inline', 'role' => 'form')) !!}
        <div class="form-group">
            {!! Form::label('name', Translate::recursive('portfolio::members.name') .': ', array('class' => 'sr-only')) !!}
            {!! Form::text('name', $input['name'], array('placeholder' => Translate::recursive('portfolio::members.name'), 'class' => 'form-control', 'id' => 'name')) !!}
        </div>
        <div class="form-group">
