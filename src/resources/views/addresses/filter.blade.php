...
<div id="addressFilters" class="collapse">
    {!! Form::open(array('route' => array('admin.addresses.filter'), 'method' => 'POST', 'id' => 'filterAddresses')) !!}
        <div class="form-row">
            ...
            <div class="col-md-6 mb-3 align-bottom">
                ...
                <div class="form-group">
                    ...
                    {!! HTML::iconRoute('admin.addresses.index', Translate::recursive('common.clear'), 'times', array(), array('class' => 'btn btn-outline-secondary')) !!}
                </div>
            </div>
        </div>
    {!! Form::close() !!}
