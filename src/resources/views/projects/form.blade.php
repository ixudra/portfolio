{!! Form::open(array('url' => $url, 'method' => $method, 'id' => $formId, 'class' => 'form-horizontal', 'role' => 'form', 'files' => true)) !!}
    ...
    <div class="well well-large">
        <div class='form-group {{ $errors->has('name') ? 'has-error' : '' }} {{ in_array('name', $requiredFields) ? 'required' : '' }}'>
            ...
            <div class="col-lg-6">
                {!! Form::text('name', $input['name'], array('class' => 'form-control', 'required' => in_array('name', $requiredFields) ? 'required' : '')) !!}
        ...
        <div class='form-group {{ $errors->has('customer_id') ? 'has-error' : '' }} {{ in_array('customer_id', $requiredFields) ? 'required' : '' }}'>
            ...
            <div class="col-lg-4">
                {!! Form::select('customer_id', $customers, $input['customer_id'], array('class' => 'form-control', 'required' => in_array('customer_id', $requiredFields) ? 'required' : '')) !!}
        ...
        <div class='form-group {{ $errors->has('description') ? 'has-error' : '' }} {{ in_array('description', $requiredFields) ? 'required' : '' }}'>
            ...
            <div class="col-lg-8">
                {!! Form::textarea('description', $input['description'], array('class' => 'form-control', 'rows' => '6', 'required' => in_array('description', $requiredFields) ? 'required' : '')) !!}
        ...
        <div class='form-group {{ $errors->has('project_type_id') ? 'has-error' : '' }} {{ in_array('project_type_id', $requiredFields) ? 'required' : '' }}'>
            ...
            <div class="col-lg-4">
                {!! Form::select('project_type_id', $projectTypes, $input['project_type_id'], array('class' => 'form-control', 'required' => in_array('project_type_id', $requiredFields) ? 'required' : '')) !!}
        ...
        <div class='form-group {{ $errors->has('start_date') ? 'has-error' : '' }} {{ in_array('start_date', $requiredFields) ? 'required' : '' }}'>
            ...
            <div class="col-lg-3">
                {!! Form::text('start_date', $input['start_date'], array('class' => 'form-control datePicker', 'required' => in_array('start_date', $requiredFields) ? 'required' : '')) !!}
        ...
        <div class='form-group {{ $errors->has('end_date') ? 'has-error' : '' }} {{ in_array('end_date', $requiredFields) ? 'required' : '' }}'>
            ...
            <div class="col-lg-3">
                {!! Form::text('end_date', $input['end_date'], array('class' => 'form-control datePicker', 'required' => in_array('end_date', $requiredFields) ? 'required' : '')) !!}
        ...
        <div class='form-group {{ $errors->has('status') ? 'has-error' : '' }} {{ in_array('status', $requiredFields) ? 'required' : '' }}'>
            ...
            <div class="col-lg-4">
                {!! Form::select('status', $statuses, $input['status'], array('class' => 'form-control', 'required' => in_array('status', $requiredFields) ? 'required' : '')) !!}
                {!! $errors->first('status', '<span class="help-block">:message</span>') !!}
            </div>
        </div>
        <div class='form-group {{ $errors->has('hidden') ? 'has-error' : '' }} {{ in_array('hidden', $requiredFields) ? 'required' : '' }}'>
            {!! Form::label('hidden', Translate::recursive('portfolio::members.hidden') .': ', array('class' => 'control-label col-lg-3', 'required' => in_array('hidden', $requiredFields) ? 'required' : '')) !!}
            <div class="col-lg-4">
