<div class="well well-large">
    <div class='form-group {{ $errors->has($prefix . 'first_name') ? 'has-error' : '' }} {{ in_array($prefix . 'first_name', $requiredFields) ? 'required' : '' }}'>
    ...
    <div class='form-group {{ $errors->has($prefix . 'last_name') ? 'has-error' : '' }} {{ in_array($prefix . 'last_name', $requiredFields) ? 'required' : '' }}'>
    ...
    <div class='form-group {{ $errors->has($prefix . 'birth_date') ? 'has-error' : '' }} {{ in_array($prefix . 'birth_date', $requiredFields) ? 'required' : '' }}'>
    ...
    <div class='form-group {{ $errors->has($prefix . 'cellphone') ? 'has-error' : '' }} {{ in_array($prefix . 'cellphone', $requiredFields) ? 'required' : '' }}'>
