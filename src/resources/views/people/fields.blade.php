<div class="well well-large">
    <div class='form-group {{ $errors->has($prefix . 'first_name') ? 'has-error' : '' }}'>
        {!! Form::label($prefix . 'first_name', Translate::recursive('members.first_name') .': ', array('class' => 'control-label col-lg-3')) !!}
        <div class="col-lg-4">
    ...
    <div class='form-group {{ $errors->has($prefix . 'last_name') ? 'has-error' : '' }}'>
        {!! Form::label($prefix . 'last_name', Translate::recursive('members.last_name') .': ', array('class' => 'control-label col-lg-3')) !!}
        <div class="col-lg-4">
    ...
    <div class='form-group {{ $errors->has($prefix . 'birth_date') ? 'has-error' : '' }}'>
        {!! Form::label($prefix . 'birth_date', Translate::recursive('members.birth_date') .': ', array('class' => 'control-label col-lg-3')) !!}
        <div class="col-lg-4">
    ...
    <div class='form-group {{ $errors->has($prefix . 'cellphone') ? 'has-error' : '' }}'>
        {!! Form::label($prefix . 'cellphone', Translate::recursive('members.cellphone') .': ', array('class' => 'control-label col-lg-3')) !!}
        <div class="col-lg-4">
